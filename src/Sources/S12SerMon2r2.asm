...
;
;
softwareID1:  equ   $0723     ;Software revision (date)
softwareID2:  equ   $2004     ;Software revision (year)
softwareID3:  equ   $0202     ;Software revision (ver)
...
;             base    10           ;ensure default number base to decimal
             ...
             include "S12SerMon2r2.inc"
             include "S12SerMon2r2.def"
...
; Below "help" on TA C32 card with incorrect DTR connection.
...
ErsBlk0:     ldab  PPAGE           ;	 Move PPAGE to Stack for storage
             pshb
...
;*********************************************************************
;* Progflash - programs one word of HCS9S12 FLASH
...
ProgFlash:   ldy    PPAGE         ;	 Move PPAGE to Stack for storage
             ...
             movb  #$3F,PPAGE     ;set ppage $3F
             bra    ProgFlash1
its3E:       movb  #$3E,PPAGE     ;set ppage $3E
